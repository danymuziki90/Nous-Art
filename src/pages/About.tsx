      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 mt-20 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 text-ink-100 leading-relaxed font-light text-base">
            ...
            <p>
              From our gallery space, we present a programme of solo and group exhibitions, working closely with a roster of artists whose practices resist easy categorisation. Painting, sculpture, photography, and works on paper sit in dialogue with one another.
            </p>
            <p>
